...
<div class="container" style="margin-top: 100px">
    ...
    <div class="row justify-content-center">
        <div class="col-sm-4">
            <div class="card">
                <img class="card-img-top" src="<?php echo base_url().'public/images/images-1.jpeg'?>" alt="Card image cap" id="dp_item">
...
<!--                    <a href="#" class="btn btn-primary">Go somewhere</a>-->
            ...
            <div class="card" >
                <img class="card-img-top" src="<?php echo base_url().'public/images/images-1.jpeg'?>" alt="Card image cap" id="pic2">
                <div class="card-block">
            ...
            <div class="card" >
                <img class="card-img-top" src="<?php echo base_url().'public/images/images-1.jpeg'?>" alt="Card image cap" id="pic3">
                <div class="card-block">
            ...
            <div class="card" >
                <img class="card-img-top" src="<?php echo base_url().'public/images/images-1.jpeg'?>" alt="Card image cap" id="pic4">
                <div class="card-block">
            ...
            <div class="card" >
                <img class="card-img-top" src="<?php echo base_url().'public/images/images-1.jpeg'?>" alt="Card image cap" id="pic5">
                <div class="card-block">
            ...
            <div class="card" >
                <img class="card-img-top" src="<?php echo base_url().'public/images/images-1.jpeg'?>" alt="Card image cap" id="pic6">
                <div class="card-block">
