...
<div class="container" style="margin-top: 100px">
    ...
    <div class="row justify-content-center">
        <div class="col-xs-6 col-sm-4 col-lg-6" style="margin: 10px">
            <div class="card">
...
<!--                    <a href="#" class="btn btn-primary">Go somewhere</a>-->
        ...
        <div class="col-xs-6 col-sm-4 col-lg-3" style="margin: 10px">
            <div class="card" >
        ...
        <div class="col-xs-6 col-sm-4 col-lg-4" style="margin: 10px">
            <div class="card" >
