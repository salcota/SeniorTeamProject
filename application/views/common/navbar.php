...
<body>    
    ...
    <nav class='navbar navbar-toggleable-sm navbar-light fixed-top navbar' style="min-height: 65px">
	...
	<!-- Left Side Menu: Logo & Home-->
        ...
        <div class='collapse navbar-collapse' id='navbarSupportedContent'>
            ...
            <form class='form-inline fix-align mr-auto' style='padding-top: 4px' action="<?php echo base_url() . "home" ?>" id="searchSubmit" method=GET>
