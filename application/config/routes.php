...
$route['remove_listing/(:num)'] = 'users/delete_listing/$1';
...
$route['update_itempic/(:any)/(:num)'] = 'itemlisting/update_listing_pic/$1/$2';
$route['remove_listing_pic/(:any)/(:num)'] = 'itemlisting/remove_listing_pic/$1/$2';
$route['translate_uri_dashes'] = FALSE;
